...
interface Props {
  code: string;
  type: DiagramType;
  setCode: React.Dispatch<React.SetStateAction<string>>; // ✅ ditambahkan
}

const DiagramPreview: React.FC<Props> = ({ code, type, setCode }) => {
    ...
    <div className="w-1/2 bg-gray-900 flex flex-col">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-b border-gray-700">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={zoomOut}
className="p-1.5 text-gray-600 hover:text-black hover:bg-gray-200"
            title="Zoom out"
          >
      ...
      <div className="flex-1 relative overflow-hidden bg-gray-900">
        ...
        {!isLoading && !error && svgContent && (
          <InteractiveDiagram
            ...
            zoom={zoom}
            editMode={editMode}
            onCodeChange={setCode}   // ✅ sekarang valid
            originalCode={code}
          />
        )}
